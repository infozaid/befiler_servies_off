...
@Table(name = "taxform_welth_statement_owe_any_loans_or_credit")
public class Taxform_WelthStatement_OweAnyLoansOrCredit extends GenericModel {
    ...
    @Column(name = "creditors_ntn_or_cnic")
    private String creatorsNtnOrCnic;

    @Column(name = "creditors_name")
