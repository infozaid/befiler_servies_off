...
@Table( name = "easypaisa_ma_request")
public class EasypaisaMARequest extends GenericModelAudit {
    @Id
    ...
    @OneToOne(cascade = CascadeType.REMOVE, mappedBy = "easypaisaMARequest")
    private EasypaisaMAResponse easypaisaMAResponse;
}
