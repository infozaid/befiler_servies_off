...
import com.arittek.befiler_services.security.service.JwtAuthenticationResponse;
...
public class AuthenticationRestController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtAuthenticationRequest authenticationRequest, HttpServletRequest request) throws AuthenticationException {
        ...
        if (authenticationRequest.getUsername() != null &&
                ...
                authenticationRequest.getLatitude() != null &&
                authenticationRequest.getLongitude() != null) {
